...
public class SqliteCodeTable {
	...
	private final String DATABASE_PATH = "/data/data/com.example.foundationreview/databases";
	...
	public void updateDatabase() {
		//String new_ver = Config.read(context, "dbversion");
		String new_ver = "2";
		String old_ver = "1";
		Log.i("TAG", "===updateDatabase: " + old_ver +"");
